    ...
    <div class="app-container">
      ...
      <div class="footer">
        <el-table v-loading="loading" :data="list" style="width: 100%" :border="true">
            ...
            <template #default="scope">
              <template v-if="scope.row.edit">
                <div style="display: flex; align-items: center">
                  ...
                  <el-button size="small" icon="Refresh" type="warning" @click="cancelEdit(scope.row)"> 取消 </el-button>
                </div>
              </template>
          ...
          <el-table-column prop="address" :show-overflow-tooltip="true" label="地址" width="180" align="center" />
          ...
          <el-table-column prop="operator" label="操作" width="180px" fixed="right" align="center">
            <template #default="scope">
              <el-button v-if="scope.row.edit" type="success" size="small" icon="CircleCheckFilled" @click="confirmEdit(scope.row)">
                保存
              </el-button>
